...
namespace CodeContractNullability.Test.Specs.AlternateTypeHierarchyModes
{
    ...
    {
        [Fact]
        public void When_method_in_mode_EverywhereInTypeHierarchy_with_interface_hierarchy_in_source_it_must_report_everywhere()
        {
            // Arrange
            ...
            // Act and assert
            VerifyNullabilityDiagnostic(source, CreateMessageForMethod("M"), CreateMessageForMethod("M"),
                CreateMessageForMethod("M"));
        }

        [Fact]
        public void
            When_method_in_mode_EverywhereInTypeHierarchy_with_external_interface_at_top_it_must_report_everywhere()
        {
            // Arrange
            ParsedSourceCode source = new ClassSourceCodeBuilder()
                .WithSettings(new AnalyzerSettingsBuilder()
        ...
        [Fact]
        public void When_method_in_mode_EverywhereInTypeHierarchy_with_annotated_external_interface_at_top_it_must_be_skipped()
        {
            // Arrange
            ParsedSourceCode source = new ClassSourceCodeBuilder()
                .WithSettings(new AnalyzerSettingsBuilder()
        ...
        [Fact]
        public void When_method_in_mode_EverywhereInTypeHierarchy_with_base_hierarchy_in_source_it_must_report_everywhere()
        {
            // Arrange
            ParsedSourceCode source = new ClassSourceCodeBuilder()
                .WithSettings(new AnalyzerSettingsBuilder()
        ...
        [Fact]
        public void When_method_in_mode_EverywhereInTypeHierarchy_with_external_base_at_top_it_must_report_everywhere()
        {
            // Arrange
            ParsedSourceCode source = new ClassSourceCodeBuilder()
                .WithSettings(new AnalyzerSettingsBuilder()
            ...
            // Act and assert
            VerifyNullabilityDiagnostic(source, CreateMessageForMethod("M"));
        }
