    ...
    public sealed class ParameterCollectionSpecs : ItemNullabilityTest
    {
        ...
        public void When_parameter_item_type_is_nullable_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .Using(typeof(IEnumerable<>).Namespace)
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] IEnumerable<int?> [|p|]) { }
                ")
                .Build();
        ...
        public void When_parameter_item_type_is_generic_nullable_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new TypeSourceCodeBuilder()
                ...
                .InGlobalScope(@"
                    class C<T> where T : struct
                    {
                        void M([+NullabilityAttributePlaceholder+] IEnumerable<T?> [|p|]) { }
                    }
                ")
                .Build();
        ...
        public void When_parameter_item_type_is_object_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .Using(typeof(IEnumerable).Namespace)
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] IEnumerable [|p|]) { }
                ")
                .Build();
        ...
        public void When_indexer_parameter_is_collection_of_reference_type_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .Using(typeof(IEnumerable<>).Namespace)
                .InDefaultClass(@"
                    int this[[+NullabilityAttributePlaceholder+] IEnumerable<string> [|p|]]
                    {
        ...
        public void When_ref_parameter_is_collection_of_nullable_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .Using(typeof(IEnumerable<>).Namespace)
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] ref IEnumerable<int?> [|p|]) { }
                ")
                .Build();
        ...
        public void When_out_parameter_is_collection_of_nullable_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .Using(typeof(IEnumerable<>).Namespace)
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] out IEnumerable<int?> [|p|]) { throw new NotImplementedException(); }
                ")
                .Build();
        ...
        public void When_parameter_in_base_constructor_is_annotated_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new TypeSourceCodeBuilder()
                ...
                .InGlobalScope(@"
                    ...
                    class D : B
                    {
                        public D([+NullabilityAttributePlaceholder+] IEnumerable<string> [|p|]) : base(p) { }
                    }
                ")
                .Build();
            ...
            ParsedSourceCode source = new TypeSourceCodeBuilder()
                ...
                .InGlobalScope(@"
                    ...
                    class C : I
                    {
                        ...
                        public void M([+NullabilityAttributePlaceholder+] IEnumerable<string> [|p|]) { }
...
")
        ...
        public void When_parameter_type_is_lazy_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] Lazy<string> [|p|]) { }
                ")
                .Build();
        ...
        public void When_parameter_type_is_generic_task_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                .Using(typeof(Task<>).Namespace)
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] Task<string> [|p|]) { }
                ")
                .Build();
        ...
        public void When_parameter_type_is_generic_value_task_it_must_be_reported_and_fixed()
        {
            ...
            ParsedSourceCode source = new MemberSourceCodeBuilder()
                ...
                .InDefaultClass(@"
                    void M([+NullabilityAttributePlaceholder+] ValueTask<string> [|p|]) { }
                ")
                .Build();
            ...
            ParsedSourceCode source = new TypeSourceCodeBuilder()
                ...
                .InGlobalScope(@"
                    namespace N
                    {
                        ...
                        public class C : B
                        {
                            public new void M([+NullabilityAttributePlaceholder+] IEnumerable<int?> [|p|]) { throw new NotImplementedException(); }
                        }
                    }
                ")
                .Build();
