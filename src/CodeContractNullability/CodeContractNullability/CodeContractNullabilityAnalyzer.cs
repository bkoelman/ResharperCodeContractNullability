...
namespace CodeContractNullability
{
    ...
    public class CodeContractNullabilityAnalyzer : DiagnosticAnalyzer
    {
        ...
        {
            var analyzer = new FieldAnalyzer(context, info.ExternalAnnotations, info.GeneratedCodeCache, false);
        ...
        {
            var analyzer = new PropertyAnalyzer(context, info.ExternalAnnotations, info.GeneratedCodeCache, false);
        ...
        {
            var analyzer = new ParameterAnalyzer(context, info.ExternalAnnotations, info.GeneratedCodeCache, false);
