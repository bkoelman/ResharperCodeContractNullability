...
namespace CodeContractNullability.SymbolAnalysis
{
    ...
    internal static class FunctionAnalysis
    {
        ...
        public static readonly ImmutableArray<MethodKind> KindsToSkip = ImmutableArray.Create(MethodKind.AnonymousFunction, MethodKind.LambdaMethod,
            MethodKind.PropertyGet, MethodKind.PropertySet, MethodKindLocalFunction);
    }
}
